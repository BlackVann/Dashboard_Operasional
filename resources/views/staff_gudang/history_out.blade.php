...
<div class="container">
  ...
  <form class="row g-3 align-items-center"  action="/gudang/history_out">
...
@if ($status)
 @foreach ($out as $item)
      ...
      <td scope="col"><a class="black" href="{{config('app.url'). 'gudang/history_out/'.$item->code}}">{{ $item->code }}</a></td>
